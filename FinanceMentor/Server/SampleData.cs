...
namespace FinanceMentor.Server
{
    public static class SampleData
    {
        ...
        public static void AddExpensesRepository(this IServiceCollection services)
        {
            ...
            expenseRepository.Add(new Expense { Date = new DateTime(today.Year, today.Month, 25), Amount = 2480, Category = ExpenseCategory.Transportaion, Subject = "Monthly Salary" });
